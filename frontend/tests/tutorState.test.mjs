...
const drawer = readFileSync(new URL('../src/components/TutorDrawer.vue', import.meta.url), 'utf8')
const resourcesView = readFileSync(new URL('../src/views/ResourcesView.vue', import.meta.url), 'utf8')
const feedbackView = readFileSync(new URL('../src/views/FeedbackView.vue', import.meta.url), 'utf8')
