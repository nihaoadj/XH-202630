  ...
  <div class="landing-page">
    <header class="landing-nav">
      <div class="landing-brand">
        <img src="/rag-logo.png" alt="RAG匠学" />
        <div>
          <strong>RAG匠学</strong>
          <span>个性化导学系统</span>
        </div>
    ...
    <main class="landing-main">
      <section class="landing-hero">
        <div class="hero-content">
          <span class="hero-kicker">MULTI-AGENT RAG LEARNING SYSTEM</span>
          <h1>RAG匠学：多智能体协同的 RAG 链路个性化导学系统</h1>
          <p>围绕学习画像、知识库检索、证据引用、资源生成和反馈迭代，构建可追踪、可复盘、可持续优化的学习路径。</p>
          ...
          <main class="auth-form-side">
            ...
            <section class="auth-form-panel" :class="{ 'auth-register-panel': authMode === 'register' }">
              <template v-if="authMode === 'login'">
                ...
                <h2>账号登录</h2>
                <p class="auth-form-subtitle">使用已注册的用户名进入 RAG匠学。</p>
...
const features = [
  ...
  { index: '02', title: 'RAG 证据链路', description: '学习资源围绕知识库证据组织，输出内容可追踪、可复盘。' },
