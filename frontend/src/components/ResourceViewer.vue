...
@media (max-width: 760px) { .reader-header { gap: 10px; min-height: 54px; padding: 11px 16px; }.reader-title-wrap { gap: 8px; }.learning-status { font-size: 12px; }.resource-kicker { padding-left: 8px; font-size: 14px; }.learning-progress, .reader-actions :deep(.el-tag) { display: none; }.reader-content, .reader-footer { padding-right: 23px; padding-left: 23px; } }
</style>
