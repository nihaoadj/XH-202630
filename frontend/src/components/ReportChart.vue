...
const lineOption = computed(() => ({
  ...
  series: [{ type: 'line', smooth: true, data: curve.value.map((item) => item.score), symbol: 'circle', symbolSize: 7, lineStyle: { color: '#2f78dc', width: 3 }, itemStyle: { color: '#2f78dc', borderColor: '#fff', borderWidth: 2 }, areaStyle: { color: { type: 'linear', x: 0, y: 0, x2: 0, y2: 1, colorStops: [{ offset: 0, color: 'rgba(45, 161, 204, .28)' }, { offset: 1, color: 'rgba(45, 161, 204, .02)' }] } } }],
}))
</script>

<style scoped>
.analysis-panel { padding:20px; border:1px solid #dbe6f2; border-radius:18px; background:rgba(255,255,255,.96); box-shadow:0 12px 28px rgba(24,60,96,.06); }.analysis-heading { display:flex; align-items:flex-start; justify-content:space-between; gap:14px; margin-bottom:16px; }.analysis-kicker,.knowledge-label { display:block; color:#2058a7; font-size:12px; font-weight:800; letter-spacing:.09em; line-height:1; }.analysis-heading h3 { margin:7px 0 0; color:#10233f; font-size:22px; font-weight:800; letter-spacing:-.035em; line-height:1.1; }.analysis-note { padding:6px 9px; border-radius:999px; background:#edf4ff; color:#2058a7; font-size:12px; font-weight:700; white-space:nowrap; }
.chart-grid { display:grid; grid-template-columns:repeat(2,minmax(0,1fr)); gap:14px; }.chart-card { min-height:310px; padding:16px; border:1px solid #dfe8f1; border-radius:14px; background:linear-gradient(145deg,#fbfdff,#f6fbf9); }.chart-card-head { display:flex; align-items:flex-start; justify-content:space-between; gap:12px; }.chart-card-head span,.chart-card-head strong { display:block; }.chart-card-head span { color:#6d8198; font-size:12px; font-weight:650; }.chart-card-head strong { margin-top:5px; color:#193754; font-size:18px; }.chart-card-head i { display:grid; width:30px; height:30px; place-items:center; border-radius:9px; font-size:12px; font-style:normal; font-weight:800; }.radar-mark { background:#e8f1ff; color:#2058a7; }.line-mark { background:#eaf3ff; color:#2d70bf; }.chart { height:246px; }.chart-card :deep(.el-empty) { height:230px; }
.knowledge-grid { display:grid; grid-template-columns:repeat(2,minmax(0,1fr)); gap:14px; margin-top:14px; }.knowledge-card { min-width:0; padding:16px; border:1px solid #dfe8f1; border-radius:14px; }.knowledge-card.weak { background:linear-gradient(120deg,#fffaf3,#fffefd); border-color:#f0e0c5; }.knowledge-card.strong { background:linear-gradient(120deg,#f5f9ff,#ffffff); border-color:#cfe2ff; }.knowledge-card.weak .knowledge-label { color:#a86c18; }.knowledge-card.strong .knowledge-label { color:#2058a7; }.knowledge-card h4 { margin:8px 0 0; color:#1a3756; font-size:18px; }.tag-list { display:flex; flex-wrap:wrap; gap:8px; margin-top:13px; }.tag-list span { padding:7px 10px; border-radius:999px; background:rgba(255,255,255,.75); color:#596f87; font-size:12px; font-weight:700; }.weak .tag-list span { border:1px solid #f0dfc3; color:#9a671e; }.strong .tag-list span { border:1px solid #cfe2ff; color:#1c7c66; }.tag-list em { color:#7d8da0; font-size:13px; font-style:normal; }
