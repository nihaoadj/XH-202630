...
_PUBLIC_PAYLOAD_KEYS = frozenset({
    ...
    "claim_warning_publish",
    "claim_publish_decision_pending",
    "claim_publish_decision",
    "factual_claim_total",
    "supported_claim_total",
    "contradicted_claim_total",
    "not_in_evidence_claim_total",
    "claim_ids",
    "completed_node_ids",
    "count",
    "decision",
...
_EVENT_SUMMARIES = {
    ...
    "resource_publication_decided": "用户已提交资源发布决定",
